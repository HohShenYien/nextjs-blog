...
2. **Readability**  
   ...
   // which is kinda ugly
   <button
     className="inline-flex justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-">
   </button>
   ```
...
```typescript
<div className={variable === 1 ? "bg-red-400" : "bg-green-400"}>
</div>
```
...
```typescript
<div
  className={variable === 1 ? "bg-red-400" :
                variable === 2 ? "bg-orange-400" : "bg-green-400"}>
</div>
```
...
```typescript
<div
  className={clsx({"bg-red-400": variable === 1,
...
```typescript
<div
  className={clsx("bg-red-400", someVar, {"bg-red-400": variable === 1})}>
</div>
```
